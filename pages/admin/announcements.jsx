...
export default function AdminAnnouncements(){
  ...
  const save=async(e)=>{ e.preventDefault(); setBusy(true); const r=await fetch('/api/admin/announcements',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(form)}); setBusy(false); if(r.ok){ setForm({title:'',body:'',visible_to:'members'}); load(); } else { alert('Save failed'); } };
  ...
  return(<Layout title="Admin • Announcements"><AdminOnly><AdminShell>
    <div className="grid md:grid-cols-2 gap-6">
      <div className="card shadow-brand"><h2 className="text-xl font-semibold mb-3">Create Announcement</h2>
