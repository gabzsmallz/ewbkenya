  ...
  return(<Layout title="Home">
    <section className="grid md:grid-cols-2 gap-6 items-center">
      <div className="card">
        ...
        <div className="mt-3 text-gray-700" dangerouslySetInnerHTML={{__html: page?.content||'We are a nonprofit dedicated to impactful engineering projects in our communities.'}}/>
