...
export default function Home({page}){
  ...
  return(<Layout title="Home">
    <section className="section grid md:grid-cols-2 gap-6 items-center">
      <div className="card shadow-brand">
        <h1 className="text-3xl font-bold" style={{color:'var(--brand-primary)'}}>{page?.title || 'Our Mission'}</h1>
      ...
      <div className="card shadow-brand"><img alt="hero" src={hero} className="rounded-xl" /></div>
    </section>
  </Layout>);
}
