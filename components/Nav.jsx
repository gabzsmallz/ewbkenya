...
export default function Nav(){
  ...
  return(<nav className="bg-white shadow"><div className="container flex items-center justify-between py-3">
    <Link href="/" className="font-semibold">Org Portal</Link>
    <div className="space-x-4">
      <Link href="/projects">Projects</Link><Link href="/donate">Donate</Link>
