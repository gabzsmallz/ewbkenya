...
export default function Layout({title,children}){
  return(<>
    ...
    <footer className="container my-16 text-sm text-gray-500">
      <div className="card"><p>© {new Date().getFullYear()} Nonprofit Org.</p><p>Support our work: Paybill/Till • Bank • <a href="/donate">Donate</a></p></div>
    </footer>
  </>);
}
